...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "change-me") # updated for secret key via env var

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv("DJANGO_DEBUG", "1") == "1" # updated for debug via env var

ALLOWED_HOSTS = os.getenv("DJANGO_ALLOWED_HOSTS", "*").split(",") # updated for allowed hosts via env var
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "zsdb"),
        "USER": os.getenv("DB_USER", "zs"),
        "PASSWORD": os.getenv("DB_PASSWORD", ""),
        "HOST": os.getenv("DB_HOST", "db"),
        "PORT": os.getenv("DB_PORT", "5432"),
    }
} # Updated for database configuration via environment variables
